...
// Currency list is loaded from /finance/api/currencies into state.currencies
...
function App() {
    ...
    // Load currency settings, available currencies, and current month paycheck from Finance summary
    useEffect(() => {
